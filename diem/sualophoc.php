...
<main>
      <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-8">
                <div class="title-module" style="text-align:center;">SỬA THÔNG TIN LỚP HỌC</div>
				        	<form name="edit_course">
						      <table class="table-form-edit" align="center" bgcolor="#FFFFFF">
  
							<tr>
								<td width="180">Mã lớp học</td>
								<td width="300"><input type="text" value="SH" size="40"></td>
							</tr>
							<tr>
								<td>Tên lớp học</td>
								<td><input type="text" value="59SH1" size="40"></td>
							</tr>
							<tr>
								<td>Ngành học</td>
                      ...
                      <option value="TLA119">Công nghệ sinh học</option>
                            ...
                            <tr>
								<td align="center" ></td>
								<td><a href="lophoc.php"><input type="submit" value="Lưu lại" name="submit"> </a>  &ensp;<input type="reset" value="Reset"></td>
                            </tr>
                            </table>
                            </form>
                </div>
